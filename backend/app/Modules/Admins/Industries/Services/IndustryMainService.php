...
class IndustryMainService extends AbstractExcelService
{
    public function model(): Builder
    {
        return Industry::isActive()->whereHas('auth', function ($query) {
            $query->whereNull('created_by')->isNotBlocked();
        });
    }
        ...
        return QueryBuilder::for($this->model())
            ...
            ->allowedFilters([
                ...
                AllowedFilter::callback('has_taluq', function (Builder $query, $value) {
                    $query->whereHas('auth', function ($query) use ($value) {
