...
class AdminNonRegisteredApplicationCollection extends ApplicationCollection
{
	/**
	...
	public function toArray($request)
	{
		...
		return array_merge($parentArray, [
			...
			'approved_by' => $this->approved_by ? ApprovedByCollection::make($this->approved_by) : null,
