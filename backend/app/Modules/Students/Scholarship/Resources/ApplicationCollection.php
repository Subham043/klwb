...
class ApplicationCollection extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'industry_category' => $this->industry->category ?? 'N/A',
            'industry_act' => $this->industry->act ?? 'N/A',
            'industry_act_label' => $this->industry->act ? Act::getValue($this->industry->act) : 'N/A',
            ...
            'industry_confirmation_report' => ($this->application_state > ApplicationState::Company->value && $this->industry->auth) ? (($this->industry->auth->reg_doc_link!=null && $this->industry->auth->sign_link!=null && $this->industry->auth->seal_link!=null && $this->industryPaymentInfo) ? true : false) : false,
