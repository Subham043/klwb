...
class ApplicationCollection extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'institute_confirmation_report' => $this->institute->auth ? (($this->institute->auth->reg_certification_link!=null && $this->institute->auth->principal_signature_link!=null && $this->institute->auth->seal_link!=null) ? true : false) : false,
            'industry_name' => $this->industry->name ?? null,
            'industry_confirmation_report' => $this->industry->auth ? (($this->industry->auth->reg_doc_link!=null && $this->industry->auth->sign_link!=null && $this->industry->auth->seal_link!=null && $this->industry->auth->gst_link!=null && $this->industry->auth->pan_link!=null && $this->industryPayment) ? true : false) : false,
