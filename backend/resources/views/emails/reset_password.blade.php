																																												...
																																												<div
																																																...
																																																<p style="font-size: 14px; line-height: 140%;">
																																																				<span style="font-size: 18px; line-height: 25.2px; color: #666666;">We
																																																								...
																																																								request to reset your password. Your OTP is
																																																								<b>{{ $data->otp }}</b></span>
																																																</p>
																																																<p style="font-size: 14px; line-height: 140%;">
																																																				&nbsp;</p>
																																																<p style="font-size: 14px; line-height: 140%;">
																																																				<span style="font-size: 18px; line-height: 25.2px; color: #666666;">To
																																																								reset your password, please click on the button given
																																																								below and enter your new password and use the OTP given above:
																																																				</span>
																																																</p>
																																												</div>
