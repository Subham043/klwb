...
import {
  AdminPersistLayout,
  InstitutePersistLayout,
  StudentPersistLayout,
  IndustryPersistLayout,
} from "./layouts/Persist";
          ...
          <Route element={<AdminPersistLayout />}>
              ...
              <Route element={<AdminVerifiedLayout />}>
                <Route element={<AdminAuthorisedLayout />}>
                  <Route element={<DashboardLayout />}>
                    ...
                    />
                    <Route
                      path={page_routes.admin.graduation}
                      element={<GraduationPage />}
                    />
                    <Route
                      path={page_routes.admin.course}
                      element={<CoursePage />}
                    />
                    <Route
                      path={page_routes.admin.class}
                      element={<ClassPage />}
                    />
                    <Route
                      path={page_routes.admin.employee}
                      element={<EmployeePage />}
                    />
                    <Route
                      path={page_routes.admin.student}
                      element={<StudentPage />}
                    />
                    <Route
                      path={page_routes.admin.state}
                      element={<StatePage />}
                    />
                    <Route
                      path={page_routes.admin.city}
                      element={<CityPage />}
                    />
                    <Route
                      path={page_routes.admin.taluq}
                      element={<TaluqPage />}
                    />
                    <Route
                      path={page_routes.admin.institute.all}
                      element={<InstitutePage />}
                    />
                    <Route
                      path={page_routes.admin.institute.request}
                      element={<RequestInstitutePage />}
                    />
                    <Route
                      path={page_routes.admin.institute.non_registered}
                      element={<NonRegisteredInstitutePage />}
                    />
                    <Route
                      path={page_routes.admin.institute.registered}
                      element={<RegisteredInstitutePage />}
                    />
                    <Route
                      path={page_routes.admin.institute.registered_info(":id")}
                      element={<RegisteredInstituteInfoPage />}
                    />
                    <Route
                      path={page_routes.admin.industry.all}
                      element={<IndustryPage />}
                    />
                    <Route
                      path={page_routes.admin.industry.request}
                      element={<RequestIndustryPage />}
                    />
                    <Route
                      path={page_routes.admin.industry.non_registered}
                      element={<NonRegisteredIndustryPage />}
                    />
                    <Route
                      path={page_routes.admin.industry.registered}
                      element={<RegisteredIndustryPage />}
                    />
                    <Route
                      path={page_routes.admin.industry.registered_info(":id")}
                      element={<RegisteredIndustryInfoPage />}
                    />
                    <Route
                      path={page_routes.admin.security_question}
                      element={<SecurityQuestionPage />}
                    />
                    <Route
                      path={page_routes.admin.application_date}
                      element={<ApplicationDatePage />}
                    />
                    <Route
                      path={page_routes.admin.application_fee}
                    ...
                    />
                    <Route
                      path={page_routes.admin.scholarship.approved_list}
                      element={<AdminScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.admin.scholarship.pending_list}
                      element={<AdminScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.admin.scholarship.rejected_list}
                      element={<AdminScholarshipListPage />}
                    />
                    <Route
                      path={
                        page_routes.admin.scholarship.payment_processed_list
                      }
                      element={<AdminScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.admin.scholarship.view(":id")}
                      element={<AdminScholarshipViewPage />}
                    />
                    <Route
                      path={page_routes.admin.contribution.pending_list}
                      element={<AdminNonContributionListPage />}
                    />
                    <Route
                      path={page_routes.admin.contribution.attempted_list}
                      element={<AdminAttemptedContributionListPage />}
                    />
                    <Route
                    ...
                    />
                    <Route
                      path={page_routes.admin.report.contribution}
                      element={<ContributionReportListPage />}
                    />
                    <Route
                      path={page_routes.admin.report.contribution_comparison}
                      element={<ContributionComparisonReportListPage />}
                    />
                  </Route>
                </Route>
                ...
                <Route element={<GovtAuthorisedLayout />}>
                  <Route element={<DashboardLayout />}>
                    <Route
                      path={page_routes.govt.dashboard}
                      element={<GovtDashboardPage />}
                    />
                    <Route
                      path={page_routes.govt.scholarship.approved_list}
                      element={<GovtScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.govt.scholarship.pending_list}
                      element={<GovtScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.govt.scholarship.rejected_list}
                      element={<GovtScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.govt.scholarship.all_list}
                      element={<GovtScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.govt.scholarship.view(":id")}
                      element={<GovtScholarshipViewPage />}
                    />
                    <Route
                      path={page_routes.govt.report.scholarship}
                      element={<GovtScholarshipReportListPage />}
                    />
                  </Route>
                </Route>
                {/* Govt Routes Ends */}
                ...
                <Route element={<FinanceAuthorisedLayout />}>
                  <Route element={<DashboardLayout />}>
                    <Route
                      path={page_routes.finance.dashboard}
                      element={<FinanceDashboardPage />}
                    />
                    <Route
                      path={
                        page_routes.finance.scholarship.payment_pending_list
                      }
                      element={<FinanceScholarshipListPage />}
                    />
                    <Route
                      path={
                        page_routes.finance.scholarship.payment_processed_list
                      }
                      element={<FinanceScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.finance.scholarship.payment_failed_list}
                      element={<FinanceScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.finance.scholarship.view(":id")}
                      element={<FinanceScholarshipViewPage />}
                    />
                  </Route>
                </Route>
                {/* Finance Routes Ends */}
                ...
                <Route element={<PaymentOfficerAuthorisedLayout />}>
                  <Route element={<DashboardLayout />}>
                    <Route
                      path={page_routes.payment_officer.dashboard}
                      element={<PaymentOfficerDashboardPage />}
                    />
                    <Route
                      path={
                        page_routes.payment_officer.contribution.pending_list
                      }
                      element={<PaymentOfficerNonContributionListPage />}
                    />
                    <Route
                      path={
                        page_routes.payment_officer.contribution.completed_list
                      }
                      element={<PaymentOfficerContributionListPage />}
                    />
                  </Route>
                </Route>
            ...
            <Route element={<AdminGuestLayout />}>
              <Route element={<AdminAuthLayout />}>
                <Route
                  path={page_routes.admin.auth.login}
                  element={<AdminLoginPage />}
                />
                <Route
                  path={page_routes.admin.auth.forgot_password}
                  element={<AdminForgotPasswordPage />}
                />
                <Route
                  path={page_routes.admin.auth.reset_password}
          ...
          <Route element={<StudentPersistLayout />}>
            <Route element={<StudentProtectedLayout />}>
              <Route element={<StudentVerifiedLayout />}>
                <Route element={<StudentAuthorisedLayout />}>
                  <Route element={<DashboardLayout />}>
                    <Route
                      path={page_routes.student.dashboard}
                      element={<StudentDashboardPage />}
                    />
                    <Route
                      path={page_routes.student.scholarship.apply}
                      element={<StudentApplyScholarshipPage />}
                    />
                    <Route
                      path={page_routes.student.scholarship.resubmit}
                      element={<StudentResubmitScholarshipPage />}
                    />
                    <Route
                      path={page_routes.student.scholarship.status}
                      element={<StudentScholarshipStatusPage />}
                    />
                    <Route
                      path={page_routes.student.scholarship.list}
                      element={<StudentScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.student.scholarship.view(":id")}
                      element={<StudentScholarshipViewPage />}
                    />
                  </Route>
                </Route>
              </Route>
            ...
            <Route element={<StudentGuestLayout />}>
              <Route element={<StudentAuthLayout />}>
                <Route
                  path={page_routes.student.auth.login}
                  element={<StudentLoginPage />}
                />
                <Route
                  path={page_routes.student.auth.register}
                  element={<StudentRegisterPage />}
                />
                <Route
                  path={page_routes.student.auth.forgot_password}
                  element={<StudentForgotPasswordPage />}
                />
                <Route
                  path={page_routes.student.auth.reset_password}
          ...
          <Route element={<InstitutePersistLayout />}>
            <Route element={<InstituteProtectedLayout />}>
              <Route element={<InstituteVerifiedLayout />}>
                <Route element={<InstituteAuthorisedLayout />}>
                  <Route element={<DashboardLayout />}>
                    <Route
                      path={page_routes.institute.dashboard}
                      element={<InstituteDashboardPage />}
                    />
                    <Route
                      path={page_routes.institute.scholarship.list}
                      element={<InstituteScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.institute.scholarship.view(":id")}
                      element={<InstituteScholarshipViewPage />}
                    />
                  </Route>
                </Route>
                <Route
                  element={
                    <InstituteAuthorisedLayout roles={[RolesEnum.INSTITUTE]} />
                  }
                >
                  <Route element={<DashboardLayout />}>
                    <Route
                      path={page_routes.institute.employee}
                      element={<InstituteEmployeePage />}
                    />
                  </Route>
                </Route>
              </Route>
            ...
            <Route element={<InstituteGuestLayout />}>
              <Route element={<InstituteAuthLayout />}>
                <Route
                  path={page_routes.institute.auth.login}
                  element={<InstituteLoginPage />}
                />
                <Route
                  path={page_routes.institute.auth.register}
                  element={<InstituteRegisterPage />}
                />
                <Route
                  path={page_routes.institute.auth.forgot_password}
                  element={<InstituteForgotPasswordPage />}
                />
                <Route
                  path={page_routes.institute.auth.reset_password}
                  element={<InstituteResetPasswordPage />}
                />
                <Route
                  path={page_routes.institute.auth.request}
                  element={<InstituteRequestPage />}
                />
              </Route>
            </Route>
          </Route>
          ...
          <Route element={<IndustryPersistLayout />}>
            <Route element={<IndustryProtectedLayout />}>
              <Route element={<IndustryVerifiedLayout />}>
                <Route element={<IndustryAuthorisedLayout />}>
                  <Route element={<DashboardLayout />}>
                    <Route
                      path={page_routes.industry.dashboard}
                      element={<IndustryDashboardPage />}
                    />
                    <Route
                      path={page_routes.industry.scholarship.list}
                      element={<IndustryScholarshipListPage />}
                    />
                    <Route
                      path={page_routes.industry.scholarship.view(":id")}
                      element={<IndustryScholarshipViewPage />}
                    />
                  </Route>
                </Route>
                <Route
                  element={
                    <IndustryAuthorisedLayout roles={[RolesEnum.INDUSTRY]} />
                  }
                >
                  <Route element={<DashboardLayout />}>
                    <Route
                      path={page_routes.industry.employee}
                      element={<IndustryEmployeePage />}
                    />
                    <Route
                      path={page_routes.industry.payment.list}
                      element={<IndustryPaymentListPage />}
                    />
                    <Route
                      path={page_routes.industry.payment.view(":id")}
                      element={<IndustryPaymentViewPage />}
                    />
                    <Route
                      path={page_routes.industry.payment.status(":id")}
                      element={<IndustryPaymentStatusPage />}
                    />
                    <Route
                      path={page_routes.industry.payment.pay}
                      element={<IndustryMakePaymentPage />}
                    />
                  </Route>
                </Route>
              </Route>
            ...
            <Route element={<IndustryGuestLayout />}>
              <Route element={<IndustryAuthLayout />}>
                <Route
                  path={page_routes.industry.auth.login}
                  element={<IndustryLoginPage />}
                />
                <Route
                  path={page_routes.industry.auth.register}
                  element={<IndustryRegisterPage />}
                />
                <Route
                  path={page_routes.industry.auth.forgot_password}
                  element={<IndustryForgotPasswordPage />}
                />
                <Route
                  path={page_routes.industry.auth.reset_password}
                  element={<IndustryResetPasswordPage />}
                />
                <Route
                  path={page_routes.industry.auth.request}
                  element={<IndustryRequestPage />}
                />
              </Route>
            </Route>
          </Route>
