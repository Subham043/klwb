...
export default function FileUploader({
  ...
  const onSubmit = handleSubmit(async () => {
    ...
    try {
      ...
      formData.append(
        name,
        getValues().file![getValues().file!.length - 1 || 0].blobFile!
      );
  ...
  return (
    <div className="p-relative">
      {loading && (
        <Loader backdrop content="loading..." vertical style={{ zIndex: 3 }} />
      )}
      <Form>
        <Form.Group>
          <Controller
              ...
              <>
                ...
                {allowed && (
                  <Form.HelpText>
                    <b>Note:</b>{" "}
                    <i>
                      Only JPG, JPEG, PNG images are allowed (It should be less
                      than 515kb)
                    </i>
                  </Form.HelpText>
                )}
