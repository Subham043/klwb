...
export default function ResetWithEmail({login_link, reset_password_redirect=page_routes.auth.student.reset_password, forgot_password_email_api_link=api_routes.user.auth.forgot_password.email}:Props) {
