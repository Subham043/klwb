...
const NonRegisteredInstitute: FC = () => {
  const { data, isLoading, isFetching, isRefetching, refetch, error } =
    useNonRegisteredInstitutesQuery();

  return (
    <PaginatedTableLayout title="Institutes Non Registered">
      <PaginatedTableLayout.Header
        title="Institutes Non Registered"
        addBtn={false}
        excelLink={api_routes.admin.non_registered_institute.excel}
        excelName="non_registered_institute.xlsx"
      >
        <SelectCityStatus />
        <SelectTaluqStatus />
        <SelectActiveStatus />
