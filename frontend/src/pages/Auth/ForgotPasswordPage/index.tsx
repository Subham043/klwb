...
export const AdminForgotPasswordPage = () => <ForgotPasswordPage title="Official" login_link={page_routes.admin.auth.login} reset_password_redirect={page_routes.admin.auth.reset_password} forgot_password_email_api_link={api_routes.admin.auth.forgot_password.email} forgot_password_phone_api_link={api_routes.admin.auth.forgot_password.phone} />
...
export const IndustryForgotPasswordPage = () => <ForgotPasswordPage title="Industry" login_link={page_routes.industry.auth.login} reset_password_redirect={page_routes.industry.auth.reset_password} forgot_password_email_api_link={api_routes.industry.auth.forgot_password.email} forgot_password_phone_api_link={api_routes.industry.auth.forgot_password.phone} />