          ...
          <div className={classes.formContainer}>
              ...
              <div className={classes.formFields}>
                <Form onSubmit={()=>onSubmit()} style={{ width: '100%' }}>
                    ...
                    <FileInput name="register_doc" accept='image/png, image/jpeg, image/jpg' label="Upload Institute Reg. Document" helpText=" Only JPG, JPEG, PNG images are allowed (It should be less than 515kb)" control={control} error={errors.register_doc?.message} />
