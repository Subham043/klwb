  ...
  return (
    <div className="row justify-center">
        <div className={classes.info_col}>
            <IntroScreen>
                <p><b>If You Don't Have an Account? <Link to={page_routes.auth.institute.register}>Register</Link></b></p>
        ...
        <div className={classes.form_col}>
            <Login title='Institute' forgot_password_link={page_routes.auth.institute.forgot_password} authenticated_redirect_link={page_routes.dashboard} login_email_api_link={api_routes.institute.auth.login.email} login_phone_api_link={api_routes.institute.auth.login.phone} />
        </div>
    </div>
  )
}
