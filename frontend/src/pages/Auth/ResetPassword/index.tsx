...
export const AdminResetPasswordPage = () => <ResetPasswordPage title="Official" login_link={page_routes.admin.auth.login} reset_password_api_link={api_routes.admin.auth.reset_password.index} reset_password_resend_otp_api_link={api_routes.admin.auth.reset_password.resend_otp} />
export const IndustryResetPasswordPage = () => <ResetPasswordPage title="Industry" login_link={page_routes.industry.auth.login} reset_password_api_link={api_routes.industry.auth.reset_password.index} reset_password_resend_otp_api_link={api_routes.industry.auth.reset_password.resend_otp} />
