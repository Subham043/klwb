...
const Graduation:FC = () => {
    ...
    return <PaginatedTableLayout title="Graduation" addHandler={() => setOpenDrawer({status:true, type:'Create'})} total={(data?.meta.total ?? 0)} excelHandler={excelHandler} excelLoading={excelLoading}>
        <Table
