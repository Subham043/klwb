          ...
          <div className="row justify-around align-center">
            <div className="col-auto text-center col-order-2">
              <img
                src={"/head1.jpeg"}
                alt=""
                className={classes.ministerLogo}
              />
              <h1 className={classes.ministerName}>
              ...
              <h2 className={classes.ministerPosition}>
                {language === LanguagesEnum.KANNADA
                  ? "ಮಾನ್ಯ ಕಾರ್ಮಿಕ ಮಂತ್ರಿ ಕರ್ನಾಟಕ ಸರ್ಕಾರ"
                  : "Hon'ble Minister of Labour Govt. of Karnataka"}
              </h2>
            </div>
          ...
          <div className="row justify-center align-center mobile-justify-between">
            <div className={classes.menuButton}>
              <Dropdown trigger="click" title={<MenuIcon />} noCaret>
                <Dropdown.Item as={NavLink} to={page_routes.main}>
                ...
                <Dropdown.Item as={"a"} href={"#report"}>
            ...
            <a href={"#about"} className={`${classes.linkMenu}`}>
              {language === LanguagesEnum.KANNADA ? "ನಮ್ಮ ಬಗ್ಗೆ" : "About Us"}
            </a>
            <a href={"#report"} className={`${classes.linkMenu}`}>
              {language === LanguagesEnum.KANNADA ? "ವರದಿಗಳು" : "Reports"}
            </a>
            <a href={"#contact"} className={`${classes.linkMenu}`}>
