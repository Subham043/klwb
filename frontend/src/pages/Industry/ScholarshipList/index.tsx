...
import { useIndustryScholarshipListQuery } from "../../../hooks/data/industry_scholarship";
...
const IndustryScholarshipListPage:FC = () => {
    const {data, isLoading, isFetching, isRefetching, refetch, error} = useIndustryScholarshipListQuery();
    ...
    return <>
        ...
        <PaginatedTableLayout title="Scholarship List">
            <PaginatedTableLayout.Header title="Scholarship List" addBtn={false} excelLink={api_routes.industry.scholarship.excel} excelName="applications.xlsx">
                <SelectStatus />
                <SelectYear />
                ...
                >
                    ...
                    <Table.Column width={250} verticalAlign="middle">
                        ...
                        <Table.Cell style={{ padding: '6px' }}>
                            {rowData => (
                                <StatusBadge status={rowData.status} application_state={rowData.application_state} current_application_state={2} />
                            )}
                        </Table.Cell>
                    </Table.Column>
...
export default IndustryScholarshipListPage